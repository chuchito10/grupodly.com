  <?php 
      ...
      $_SESSION['AuthUser']     = $EncrypData->cadenaEncrypt($AdminLogin);
      $_SESSION['AuthPassword'] = $EncrypData->cadenaEncrypt($AdminPassword);

      $_SESSION['Ecommerce-ImgNotFound'] = '../../public/img/notfound.png';
   ...
   ?>
    ...
    <div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
        <div class="user-ava"><img src="../../public/plantilla/img/account/user-ava-md.jpg" alt="Daniel Adams">
        </div>
        <div class="user-info">
      ...
      <nav class="offcanvas-menu">
        <ul class="menu">
          <li class="has-children"><span><a href="../Home/"><span>Home</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
    ...
    <header class="navbar navbar-sticky">
      ...
      <form class="site-search" method="get">
        <input type="text" name="site_search" placeholder="Buscar producto...">
      ...
      <div class="site-branding">
        <div class="inner">
          ...
          <!-- Site Logo--><a class="site-logo" href="../Home/"><img src="../../public/plantilla/img/logo/logo.png" alt="Unishop"></a>
        </div>
      </div>
      <!-- Main Navigation-->
      <nav class="site-menu">
        <ul>
          ...
          <li class="has-megamenu">
            <a href="../Categorias/index.php?id=1"><span>Categorias</span></a>
          </li>
          <li>
            <a href="../Contacto/"><span>Contacto</span></a>
          </li>
          <li>
            <a href="shop-grid-ls.html"><span>Nosotros</span></a>
          </li>
        </ul>
      </nav>
      <div id="credencialesaccess" primero="<?php echo $_SESSION['AuthUser']; ?>" segundo="<?php echo $_SESSION['AuthPassword']; ?>"></div>
      <!-- Toolbar-->
      <div class="toolbar">
        <div class="inner">
          <div class="tools">
            <div class="search"><i class="icon-search"></i></div>
              <div class="account"><a href="<?php echo isset($_SESSION['Ecommerce-ClienteKey']) ? '../Cuenta/index.php?menu=2' : '../Login/' ?>"></a><i class="icon-head"></i>
                <?php if (isset($_SESSION['Ecommerce-ClienteKey'])): ?>
                <ul class="toolbar-dropdown">
                  <li class="sub-menu-user">
                    <div class="user-ava"><img src="../../public/plantilla/img/account/user-ava-sm.jpg" alt="Daniel Adams">
                    </div>
                    <div class="user-info">
                      <h6 class="user-name"><?php echo $_SESSION['Ecommerce-ClienteNombre'] ?></h6>
                    </div>
                  </li>
                    <li><a href="../Cuenta/index.php?menu=2">Perfil</a></li>
                  <li class="sub-menu-separator"></li>
                  <li><a href="../Login/logout.php"> <i class="icon-unlock"></i>Salir</a></li>
                </ul>
                <?php endif ?>
              </div>
